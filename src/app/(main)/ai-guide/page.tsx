      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            Get real-time feedback on your yoga poses using advanced 🤖 computer vision technology.
        ...
        {cameraPermission === null && (
          <div className="max-w-2xl mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
            <div className="text-center mb-6">
              ...
              <h2 className="text-2xl font-semibold mb-4">Enable Camera for 🤖 Guidance</h2>
        ...
        <div className="mt-16 max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-8">🤖 Yoga Guide Features</h2>
