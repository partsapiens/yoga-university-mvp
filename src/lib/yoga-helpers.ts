...
/**
 * Remaps override indices after a drag-and-drop move. This function is intentionally
 * dense to correctly handle sparse overrides. It iterates through all possible indices
 * up to the max known override index and calculates the new position for each
 * override that actually exists.
 * @param old The original overrides object.
 * @param from The starting index of the moved item.
 * @param to The ending index of the moved item.
 * @returns A new overrides object with indices adjusted.
 */
