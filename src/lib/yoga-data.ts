...
export const POSES: Pose[] = [
  { id: PoseId.Butterfly,   name: "Butterfly Pose",           sanskrit: "Baddha Konasana",                         intensity: 2, groups: ["Hips"],                    family: "Seated",    defaultSeconds: 60, icon: "🦋", description: "Opens the hips and groin areas. A great pose for improving flexibility in the inner thighs." },
  ...
  { id: PoseId.Warrior1Right,  name: "Warrior I (Right)",         sanskrit: "Virabhadrāsana I",                        intensity: 3, groups: ["Hips", "Core"],            family: "Standing",  defaultSeconds: 45, icon: "🛡️", description: "Builds strength and confidence. Stretches the chest, lungs, shoulders, neck, belly, and groin." },
  { id: PoseId.HighLungeRight, name: "High Lunge (Right)",        sanskrit: "Añjaneyāsana",                            intensity: 3, groups: ["Hips", "Core"],                    family: "Standing",  defaultSeconds: 45, icon: "🏹", description: "A deep stretch for the hip flexors and quadriceps. Improves balance and concentration." },
  ...
  { id: PoseId.Bridge,      name: "Bridge Pose",               sanskrit: "Setu Bandha Sarvāṅgāsana",                intensity: 2, groups: ["Spine", "Core"],                  family: "Backbend",  defaultSeconds: 60, icon: "🌉", description: "Stretches the chest, neck, and spine. Calms the body and can help alleviate stress." },
  { id: PoseId.Pigeon,      name: "Sleeping Pigeon",           sanskrit: "Eka Pada Rajakapotasana (prep)",          intensity: 2, groups: ["Hips"],                   family: "Hip Opener",defaultSeconds: 60, icon: "🕊️", description: "A deep hip opener that releases tension in the hips and lower back. Great for after a long day of sitting." },
  { id: PoseId.Boat,        name: "Boat Pose",                 sanskrit: "Nāvāsana",                                intensity: 4, groups: ["Core", "Hips"],               family: "Core",      defaultSeconds: 40, icon: "🚤", description: "Strengthens the abdominal muscles, hip flexors, and spine." },
